...
public class MyBatisTemplate {
    ...
    public List<Map<String, Object>> findFestivalList() {
        return sqlSession.selectList("mapper.FestivalMapper.findFestivalList");
    }
    ...
    public List<Map<String,Object>> findFestivalList(
        ...
        return sqlSession.selectList("mapper.FestivalMapper.findFestivalListBy",parametest);
    }
    ...
    public List<Festival> findFestivalDtoList() {
        return sqlSession.selectList("mapper.FestivalMapper.findFestivalDtoList");
    }

    /**
     * 4. 반환타입을 resultmap을 활용한 연관관계 매핑된
     */
   public List<Festival> findFestivalMapDtoList() {
        return sqlSession.selectList("mapper.FestivalMapper.findFestivalMapDtoList");
    }
    ...
    public List<Festival> findFestivalRelationList() {
        return sqlSession.selectList("mapper.FestivalMapper.findFestivalRelationList");
    }
